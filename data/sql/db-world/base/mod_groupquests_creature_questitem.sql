...
-- Sunfury Arcanist
DELETE FROM `creature_questitem` WHERE `CreatureEntry`=20134 AND `ItemId`=28564;
INSERT INTO `creature_questitem` (`CreatureEntry`, `Idx`, `ItemId`) VALUES (20134, 1, 28564);
...
INSERT INTO `creature_questitem` (`CreatureEntry`, `Idx`, `ItemId`) VALUES (25452, 2, 34774);
-- Tundra Crawler
DELETE FROM `creature_questitem` WHERE `CreatureEntry`=25454 AND `ItemId`=34774;
INSERT INTO `creature_questitem` (`CreatureEntry`, `Idx`, `ItemId`) VALUES (25454, 0, 34774);
-- Plagued Magnataur
DELETE FROM `creature_questitem` WHERE `CreatureEntry`=25615 AND `ItemId`=34774;
INSERT INTO `creature_questitem` (`CreatureEntry`, `Idx`, `ItemId`) VALUES (25615, 0, 34774);
...
-- Bloodspore Moth
DELETE FROM `creature_questitem` WHERE `CreatureEntry`=25464 AND `ItemId`=34974;
INSERT INTO `creature_questitem` (`CreatureEntry`, `Idx`, `ItemId`) VALUES (25464, 1, 34974);
...
-- Emperor Cobra
DELETE FROM `creature_questitem` WHERE `CreatureEntry`=28011 AND `ItemId`=38575;
INSERT INTO `creature_questitem` (`CreatureEntry`, `Idx`, `ItemId`) VALUES (28011, 5, 38575);
...
-- Gundrak Raptor
DELETE FROM `creature_questitem` WHERE `CreatureEntry`=29334 AND `ItemId`=44921;
INSERT INTO `creature_questitem` (`CreatureEntry`, `Idx`, `ItemId`) VALUES (29334, 0, 44921);
