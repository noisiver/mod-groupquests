...
-- Kim'jael's Equipment (Quest: Kim'jael Indeed! (Id: 3601))
-- Changed from 180 seconds to 1 second
UPDATE `gameobject` SET `spawntimesecs`=1 WHERE `id`=153123;
...
-- Chunk of Saronite (Quest: Pure Evil (Id: 12584))
...
-- Raised Mud (Quest: An Embarassing Incident (Id: 12699))
-- Changed id of alternate object
UPDATE `gameobject` SET `id`=190778 WHERE `id`=190779;
